    ...
    <div className={"container-fluid "}>
      <div className={"row justify-content-center " + styles.divRow}>
        <div className={"col-11 mt-3 col-12"}>
          <h5 className="font-weight-bold" href="/">
            {app_config.APP_NAME}
          </h5>
        </div>
        <div className={"col-12 " + styles.col1}>
          <hr />
        </div>
        ...
        <div className={"col-12 " + styles.col2}>
          <div className="list-group list-group-flush">
            <div
              ...
              className={styles.mainIconsDashDiv}
            >
              <div className="container-fluid">
                <div className={"row "}>
                  <div className="col-3">
      ...
      <div className="row">
        <div
          className={
            "col-10 border border-danger rounded-pill " + styles.colSell
          }
        >
          <Sell />
        </div>
