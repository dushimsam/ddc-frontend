        ...
        <div className="bg-white vh-100 border-right pt-2 pb-4 pl-4">
            ...
            <div className="dashboard my-3">
                <Link href={getDashboardLink(authUser)} passHref>
                    <div
                        style={{color: '#707070'}}
                        className={"d-flex px-3 py-2 rounded-sm align-items-center mr-3 " + (Router.pathname === getDashboardLink(authUser) ? styles.sidebarActiveLink + " " + globalStyles.globalBackColor : styles.sidebarLink)}>
                        <div>
            ...
            <div className={"main-menu " + styles.mainMenu}>
                {
                    navList.map((list, i) => (
                        <Link href={list.href} key={i} passHref>
                            <div
                                className={"d-flex px-3 py-2 rounded-sm align-items-center mb-2 text-secondary mr-3 " + (Router.pathname.includes(list.href, 0) ? styles.sidebarActiveLink + " " + globalStyles.globalBackColor : styles.sidebarLink)}>
