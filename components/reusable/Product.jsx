  ...
  return (
    ...
    >
      ...
      <div className="mt-2 d-flex justify-content-between align-items-start px-1">
        <div className="pl-1">
          <p
            className="text-secondary  cursor-pointer font-weight-bolder"
      ...
      <div className={"ml-2 mt-n2"}>
        <div
          className={"rounded px-2 py-1 mr-5"}
          style={moreStyles.div_category}
        >
      ...
      {!hideBtn ? (
        <>
          ...
          <button
            onClick={() => addToCart()}
            className={
              "btn px-2 py-1 text-white " + globalStyles.globalAddToCartBtn
            }
            style={moreStyles.button}
          >
            <CartIcon height={16} width={16} /> Add to cart
          </button>
        </>
      ) : (
        <></>
