...
export default function AddToCartModel() {
    ...
    const prod = (useSelector(state => state.cart)).find(product => product._id === thisModalState.product?._id)
            ...
            <Modal.Header className={styles.modalHeader}>
                {
                    available ?
                        ...
                        <div className={"col-10"}><PartAvailability availabilityDetails={availabilityDetails}
                ...
                <div className={"model-close  " + styles.modalClose}>
                    ...
                    <button onClick={handleClose} className={styles.modalXBtn + " " + globalStyles.globalBackColor}>
                    ...
                    <div className="row">
                        <div className="col-md-4">
                            <img
                                ...
                                src={
                                    thisModalState.product?.product?.imageUrls[0]
                                }
                                onError={(e) => {
