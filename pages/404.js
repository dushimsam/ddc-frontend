            ...
            <div className="container-fluid bg-white px-3 px-sm-4 py-5 px-md-5" style={{height: '100vh'}}>
                <div className="px-0 py-0 px-sm-2 px-md-4 px-md-5">
                    ...
                    <div className="text-center mt-5">
                        <button className={"btn  btn-lg col-8 col-sm-6 col-md-4"} style={{backgroundColor: '#31B0D5', color: 'white', fontSize: '15px', textTransform: 'uppercase'}} onClick={() => Router.push('/')}>Go to home</button>
                    </div>
                </div>
            </div>
        </div>
